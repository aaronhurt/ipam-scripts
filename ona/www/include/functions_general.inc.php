...
///////////////////////////////////////////////////////////////////////
//  Function: update_serial (int $id)
//
//   $id   = domain id for serial update
//
//   Returns true (success) or false (error)
///////////////////////////////////////////////////////////////////////
function update_serial($id) {
    global $onadb;
    // write current timestamp to database as serial for given domain
    list($status, $rows) = db_update_record($onadb, 'domains', array('id' => $id), array('serial' => time()));
    // check for errors and return 1 on error
    if ($status or !$rows) {
        return true;
    }
    // return 0 on success
